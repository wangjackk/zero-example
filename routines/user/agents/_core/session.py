"""Session state and replay support for the claudecode agent."""
...
class Session:
    """Runtime aggregate for one claudecode session."""
...
class SessionStore:
    ...
    def open(
        ...
        *,
        ...
        # ctx 由 agent 在 _init_session 里构造 (需要 ov_config 决定 Local/Ov).
